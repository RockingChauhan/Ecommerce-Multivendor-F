...
const Auth = () => {
    ...
    return (
        <div className='flex justify-center h-[90vh] items-center'>
            <div className='max-w-md w-full h-[85vh] rounded-md border shadow-lg'>
                <img className='w-full rounded-t-md' src="/turquoise-background-designify.png" alt="Background" />
